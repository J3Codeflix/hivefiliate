...
export default function DeleteAccount(props) {
  ...
  function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
		...
		formData.append('type','admin_affiliatedelete');
      ...
      setspinner(false);
			if(obj==1){
				resetForm();
				if(buttonclick==1){callalert(true,{text:'Affiliate successfully deleted temporarily',type:'success',size:'full',open:true});reloadlist();closeModal(false);}
		...
		<div className="modalwrapper">
		     <Formik
                ...
                <Message
                  ...
                  list={[
                    'The account will deleted temporarily and will be place on deleted affiliate under settings menu. However, take note that the account will no longer works on any transaction like login, tracking etc.',
                    ...
                    'If you are so sure that this account will no longer needed, then you can remove instantly on deleted affiliate under settings menu.',
                  ]}
                />
