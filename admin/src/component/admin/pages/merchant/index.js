...
import PaymentComponent from './action/payment'
	        ...
	        <div className="pages-wrapper">
              ...
              <div className="page-title-wrapper">
									<div className="columns is-mobile is-vcentered">
											<div className="column page-title">Merchant Store List</div>
											<div className="column breadcrumps">
													<span><a href={LinkURL('dashboard')}>Dashboard</a></span><i className="ti-angle-right"></i><span>Merchant list</span>
											</div>
									</div>
							</div>
                  ...
                  {spinner&&Spinning()}
										...
										<div className="columns is-vcentered is-mobile">
												...
												<div className="column">
														<div className="text-right">
															<Button icon className='basic' onClick={()=>setadd(true)}><Icon name='plus circle' /> Add Merchant Store</Button>
									      ...
									      <Table.Row>
											...
											<Table.Body>
													...
													{list.map(function(data, key){
														return <Table.Row key={key} className={data.days_remaining<1?'negative':data.days_remaining>0&&data.days_remaining<=7?'warning':'positive'}>
															  ...
															  <Table.Cell>{data.dateadded}</Table.Cell>
																...
																}}><Icon name='calendar alternate outline' /> Plan</Button>
					...
					{payment&&<PaymentComponent close={close} reload={listreload} alert={openAlert} data={data}/>}
