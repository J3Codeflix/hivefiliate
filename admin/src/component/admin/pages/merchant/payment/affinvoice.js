...
import {getid,affiliateid} from '../../../../config/queryurl'
...
export default function AffInvoice(props) {
    ...
    if(getid()==null||getid()==''||affiliateid()==null||affiliateid()==''){
			windowLocation('/merchant/affpayment');
		}
    setspinner(true);
    let formData = new FormData();
    formData.append('type','payment_affinvoice');
              ...
              <div className="page-title-wrapper">
									<div className="columns is-mobile is-vcentered">
											<div className="column page-title">
												<Button className='green' icon as="a" href={LinkURL('/merchant/affpayment')}><Icon name='arrow alternate circle left outline' /> Back to Payment </Button>
													<ReactToPrint
                             ...
                             <Table.Cell textAlign='right'>{info.payment_date}</Table.Cell>
								...
								<div className="invoice-table">
										<Table celled>
											...
											<Table.Footer>
												<Table.Row>
													<Table.HeaderCell className="totalfooter" textAlign='right' colSpan='4'>Total</Table.HeaderCell>
