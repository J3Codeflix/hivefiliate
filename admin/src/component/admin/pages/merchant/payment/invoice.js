...
export default function Invoice(props) {
    ...
    formData.append('type','payment_invoice');
											...
											<Table.Body>
												{list.map(function(data, key){
													return <Table.Row key={key}>
															...
															<Table.Cell><a target="_blank" href={LinkURL('/merchant/affinvoice/?id='+info.reference_id+'&affiliate='+data.affiliate_id)}>{data.affiliate}</a></Table.Cell>
