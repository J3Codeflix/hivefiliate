...
export default function DeleteAccount(props) {
  ...
  function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
		...
		formData.append('type','admin_deleteorder');
      ...
      setspinner(false);
			if(obj==1){
				resetForm();
				if(buttonclick==1){callalert(true,{text:'Order successfully deleted on the database',type:'success',size:'full',open:true});reloadlist();closeModal(false);}
		...
		<div className="modalwrapper">
		     <Formik
                ...
                <Message
                  ...
                  header='Delete Order'
                  list={[
                    'This action is not ireversible and it will be deleted on the database',
                  ]}
                />
