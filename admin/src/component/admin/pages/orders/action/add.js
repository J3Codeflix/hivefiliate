...
export default function AddComponent(props) {
  ...
  function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
    ...
    const datavlues = {
		...
		formData.append('type','admin_addorder');
      ...
      setspinner(false);
			if(obj==1){
				resetForm();
				if(buttonclick==1){callalert(true,{text:'Order successfully added',type:'success',size:'full',open:true});reloadlist();closeModal(false);}
