...
export default function RetrieveAccount(props) {
  ...
  function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
		...
		formData.append('type','affiliate_retrieveback');
      ...
      setspinner(false);
			if(obj==1){
				resetForm();
				if(buttonclick==1){callalert(true,{text:'Affiliate successfully retrieved',type:'success',size:'full',open:true});reloadlist();closeModal(false);}
