...
export default function DeleteAccount(props) {
  ...
  function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
		...
		formData.append('type','affiliate_wipedata');
      ...
      setspinner(false);
			if(obj==1){
				resetForm();
				if(buttonclick==1){callalert(true,{text:'Affiliate successfully deleted on the database',type:'success',size:'full',open:true});reloadlist();closeModal(false);}
		...
		<div className="modalwrapper">
		     <Formik
                ...
                <Message
                  ...
                  list={[
                    'This action is not ireversible, It will remove the entire information on the database.',
                    'If you are so sure this action then procceed.',
                  ]}
                />
