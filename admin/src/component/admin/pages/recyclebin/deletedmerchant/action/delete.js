...
export default function DeleteAccount(props) {
  ...
  function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
		...
		formData.append('type','admin_merchantwipeout');
      ...
      setspinner(false);
			if(obj==1){
				if(buttonclick==1){callalert(true,{text:'Store successfully deleted on the database.',type:'success',size:'full',open:true});reloadlist();closeModal(false);}
