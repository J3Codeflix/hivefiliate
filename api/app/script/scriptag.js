...
/*function startVisitTracking(cookie_id){
    var post_data = 'mode_type=tracking&hivefiliate_id='+cookie_id + '&hivefiliate_user='+cookie_id + '&location_type='+window.location.hostname;
    PostDataRequest(path_url, post_data, function(data){ console.log(data); });
}*/
