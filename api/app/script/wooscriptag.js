var path_url = 'https://www.hivefiliate.com/api/app/tracking/woocommerce/tracking.php';
...
function markPurchase(order_id,order_total,coupon){
  var post_data = 'mode_type=tracking_purchase&order_id='+order_id+'&order_total='+order_total+'&coupon='+coupon+'&location_type='+window.location.hostname;
  PostDataRequest(path_url, post_data, function(data){});
}
