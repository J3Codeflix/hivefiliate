<?php
  function RegisterAffiliateNotification($email,$link,$name,$merchant,$password){
      ...
      $mail->addAddress(serveremail());
    	...
    	$mail->isHTML(true);
    	$mail->Subject = "You are registered as affiliate";
      ...
      <html>
  	    ...
  	    <body '.$bodybg.'>
  	    	<div '.$divgrid.'>
                  ...
                  <p style="opacity:0.9;">Congratulations! You are registered as affiliate on '.$merchant.'<br>
