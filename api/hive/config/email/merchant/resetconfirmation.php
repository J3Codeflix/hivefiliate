<?php
function ResetConfirmation($email,$link){
    	$mail = new PHPMailer;
    	$mail->CharSet = 'UTF-8';
                                ...
                                <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:22px;line-height: 24px;">Your password has been changed</span></td>
                                      </tr>
                                      <tr>
                                        <td height="24" &nbsp;=""></td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:14px;line-height:24px;">Your Hivefiliate password has been updated and it works like a charm. Nice job.</span></td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                                      </tr>
                                      <tr>
                                        <td valign="top" width="48%" align="center">
                                          <span><a href="'.$link.'" style="display:block; padding:15px 25px; background-color:#39517c; color:#ffffff; border-radius:3px; text-decoration:none;">Back To Hivefiliate</a></span>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                                      ...
                                      <tr>
                                        <td align="center">
                                          <p style="color:#a2a2a2; font-size:12px; line-height:17px; font-style:italic;">If you didn’t just reset your password, get in touch with us so we can help secure your account. Email us at <a href="mailto:help@hivefiliate.com">help@hivefiliate.com.</a></p>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
