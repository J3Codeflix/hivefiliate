<?php
function PaymentSent($paid_sum,$payment_date,$comments,$email,$name,$merchant){
    	$mail = new PHPMailer;
    	$mail->CharSet = 'UTF-8';
                                ...
                                <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:22px;line-height: 24px;">'.$merchant.' Just Made A Payment!</span></td>
                                      </tr>
                                      <tr>
                                        <td height="24" &nbsp;=""></td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align="center">
                                          <span style="color:#39517c;font-size:14px;line-height:24px;">The '.$merchant.' as your affiliate partner just placed payment for you. The amount of '.$paid_sum.' USD was sent to your affiliate account.</span>
                                        </td>
                                      </tr>
