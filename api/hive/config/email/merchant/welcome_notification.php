<?php
  function MerchantWelcomRegisterNotification($store_name,$email){
    	$mail = new PHPMailer;
    	$mail->CharSet        = 'UTF-8';
      ...
      $mail->SMTPSecure     = 'tls';
    	...
    	$mail->addAddress('admin@hivefiliate.com');
    	$mail->isHTML(true);
    	$mail->Subject = "New Registered Merchant";
  	  $mail->Body    = '
      <html>
        <head>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                          <img alt="Hivefiliate" width="400" src="https://content-na.drive.amazonaws.com/cdproxy/share/YCcp7JPXtzaYIJNg207B9ruWak6akFZ2fsIggvOkOd2/nodes/uswiXAOsQ32emLH4T1K9uQ?nonce=igzEc3wIm-OUmlkgKkXzDXID_plKXcttk3HMWk3ZoAtzzckNPGOV42yDcTbD6foU&viewBox=1600%2C1200&ownerId=A1RFXJZB43BVFB"
                                           />
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:22px;line-height: 24px;">New Registered Merchant!</span></td>
                                      </tr>
                                      <tr>
                                        <td height="24" &nbsp;=""></td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:14px;line-height:24px;">'.$email.' newly registered account. To see the complete details, please login to Super Admin.</span></td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                                      </tr>
                                      <tr>
                                        <td valign="top" width="48%" align="center"><span><a href="https://www.hivefiliate.com/controlpanel_super" style="display:block; padding:15px 25px; background-color:#39517c; color:#ffffff; border-radius:3px; text-decoration:none;">Login to Super Admin</a></span></td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                                      </tr>
