                              ...
                              <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td align="center"> <span style="color:#39517c;font-size:22px;line-height: 24px;">Changing your password</span></td>
                                    </tr>
                                    <tr>
                                      <td height="24" &nbsp;=""></td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td align="center"> <span style="color:#39517c;font-size:14px;line-height:24px;">Need to reset your password? No problem. Just click below to get started.</span></td>
                                    </tr>
                                    <tr>
                                      <td height="20" &nbsp;=""></td>
                                    </tr>
                                    <tr>
                                      ...
                                      <span><a href="'.$link.'" style="display:block; padding:15px 25px; background-color:#39517c; color:#ffffff; border-radius:3px; text-decoration:none;">Reset my password</a></span>
                                      </td>
                                    </tr>
                                    <tr>
                                      <td height="20" &nbsp;=""></td>
