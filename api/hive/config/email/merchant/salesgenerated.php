<?php
function SalesGenerated($email,$link,$affiliate,$store,$type,$order_id,$com){
    	$mail = new PHPMailer;
    	$mail->CharSet = 'UTF-8';
      ...
      //$mail->AddEmbeddedImage(pathlogo(), 'logo_');
    	...
    	$mail->isHTML(true);
    	$mail->Subject = "New Sales Generated";

      if($type=="affiliate"){$display_affiliate ='style="display:block"';}else{$display_affiliate ='style="display:none"';}
      if($type=="merchant"){$display_merchant ='style="display:block"';}else{$display_merchant ='style="display:none"';}

  	  $mail->Body   = '
      <html>
        <head>
          <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
          <title>Hivefiliate - New Sales</title>
        </head>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                          <img alt="Hivefiliate" width="400" src="https://content-na.drive.amazonaws.com/cdproxy/share/JXd4813gLJxJD0bZmPT76ipkKsCTYzojcj1voQ6absX/nodes/98wtI-pNSjiO4N9GyIpFdg?nonce=WkWZkTZDuHu0cIq89U5ygw86tHTkTGPM-Ya_cKNn_TZjPhwc0BxNyM0aq9vJFPuf&ownerId=A1RFXJZB43BVFB"
                                           />
                                        </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr '.$display_merchant.'>
                                        <td align="center" style="text-align:center;"> <span style="color:#39517c;font-size:22px;line-height: 24px;text-align:center;">'.$affiliate.' Just Made A Sale, Congrats!</span></td>
                                      </tr>
                                      <tr '.$display_affiliate.'>
                                        <td align="center" style="text-align:center;"> <span style="color:#39517c;font-size:22px;line-height: 24px;text-align:center;">New Referred Order</span></td>
                                      </tr>
                                      ...
                                      <tr '.$display_merchant.'>
                                        <td align="center">
                                          <span style="color:#39517c;font-size:14px;line-height:24px;">A customer referred by '.$affiliate.' has just placed an order at '.$store.'. Thus, it was recorded on your dashboard. You can check the order status anytime by logging into your account.</span>
                                        </td>
                                      </tr>

                                      <tr '.$display_affiliate.'>
                                        <td align="center">
                                          <span style="color:#39517c;font-size:14px;line-height:24px;">A customer referred by you has just placed an order '.$order_id.' at '.$store.'. Thus, '.$com.' USD was credited to your affiliate account. You can check the order status anytime by logging into your account.</span>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <span><a href="'.$link.'" style="display:block; padding:15px 25px; background-color:#39517c; color:#ffffff; border-radius:3px; text-decoration:none;">Login To Dashboard</a></span>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td valign="top" align="center"> <span style="font-family: -apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,&#39;Roboto&#39;,&#39;Oxygen&#39;,&#39;Ubuntu&#39;,&#39;Cantarell&#39;,&#39;Fira Sans&#39;,&#39;Droid Sans&#39;,&#39;Helvetica Neue&#39;,sans-serif; color:#9EB0C9; font-size:10px;">&copy;
                                  <a href="'.websiteurl().'" target="_blank" style="color:#9EB0C9 !important; text-decoration:none;">Hivefiliate</a> 2019
                                </span>
                                </td>
                              </tr>
                              <tr>
