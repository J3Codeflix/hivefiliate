<?php
function SubscriptionPayment($email,$store_name,$monthly_sub,$monthly_price,$total,$arrange_by,$transaction_id){
    	$mail = new PHPMailer;
    	$mail->CharSet = 'UTF-8';
      ...
      //$mail->AddEmbeddedImage(pathlogo(), 'logo_');
    	...
    	$mail->isHTML(true);
    	$mail->Subject = $store_name. " Sent Payment Subscriptions";
                                ...
                                <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center" style="text-align:center;"> <span style="color:#39517c;font-size:22px;line-height: 24px;text-align:center;">'.$store_name.' Just Made A Payment Subscriptions!</span></td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align="center">
                                          <span style="color:#39517c;font-size:14px;line-height:24px;">A customer has just pay for subscription of '.$monthly_sub.'months plan. Total amount of '.$total.' USD was sent to your paypal account</span>
                                        </td>
                                      </tr>
