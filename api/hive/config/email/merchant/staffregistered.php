<?php
function StaffRegistered($email,$link,$name,$merchant,$password){
    	$mail = new PHPMailer;
    	$mail->CharSet = 'UTF-8';
      ...
      //$mail->AddEmbeddedImage(pathlogo(), 'logo_');
    	...
    	$mail->isHTML(true);
    	$mail->Subject = "Registered as merchant staff";
  	  $mail->Body   = '
      <html>
      <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Hivefiliate - Forgot Password</title>
      </head>
                              ...
                              <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td align="center"> <span style="color:#39517c;font-size:22px;line-height: 24px;">You are registered as staff of '.$merchant.'</span></td>
                                    </tr>
                                    <tr>
                                      <td height="24" &nbsp;=""></td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td align="center"> <span style="color:#39517c;font-size:14px;line-height:24px;">This are the login details. However, you can reset your password later. Just click below to get started.</span></td>
                                    </tr>
                                    <tr>
                                      <td align="center"> <span style="color:#39517c;font-size:14px;line-height:24px;">Email: '.$email.' | Password: '.$password.'</span></td>
                                    </tr>
                                    <tr>
                                      <td height="20" &nbsp;=""></td>
                                    </tr>
                                    ...
                                    <tr>
                                      <td align="center">
                                        <p style="color:#a2a2a2; font-size:12px; line-height:17px; font-style:italic;">If you didn&#39;t request to change your Hivefiliate password, you don&#39;t have to do anything. So that&#39;s easy.</p>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
