...
require('serveremail.php');
  ...
  function MerchantRegisteredStore($email,$link,$name,$password){
      ...
      $mail->addAddress(serveremail());
    	...
    	$mail->isHTML(true);
    	$mail->Subject = "Welcome To Hiveffiliate";
  	  $mail->Body   = '
      <html>
        <head>
                                ...
                                <td class="content" colspan="2" valign="top" align="center" style="padding-left:90px; padding-right:90px;">
                                  <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:22px;line-height: 24px;">Welcome To Hivefiliate !</span></td>
                                      </tr>
                                      <tr>
                                        <td height="24" &nbsp;=""></td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td align="center"> <span style="color:#39517c;font-size:14px;line-height:24px;">Increase customers, referrals, and revenue by leveraging the power of word-of-mouth today.</span></td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                                      </tr>
                                      <tr>
                                        <td valign="top" width="48%" align="center"><span><a href="'.loginmerchant('login').'" style="display:block; padding:15px 25px; background-color:#39517c; color:#ffffff; border-radius:3px; text-decoration:none;">Lets Get Started</a></span></td>
                                      </tr>
                                      <tr>
                                        <td height="20" &nbsp;=""></td>
                                      </tr>
