                ...
                <div className="tutorial-accordion">
                    <Accordion fluid styled>
                        ...
                        <Accordion.Title
                            ...
                            onClick={()=>setactive(3)}
                        >
                        <Icon name='dropdown' />Tracking methods
                        </Accordion.Title>
                        <Accordion.Content className="accontent" active={activeIndex === 3}>

                            <p>Hiveffiliate offers Link or Coupon Code tracking methods for your affiliate program.</p>
                            ...
                            <div className="link-tracking">
                                ...
                                <Message
                                    warning
                                    icon='info circle'
                                    header='Here are the main information for link tracking:'
                                    list={[
                                        ...
                                        'Commission type for link tracking – This option allows you to choose whether the commission will be calculated as a percentage of the price of the product ("Percent from purchase"), as a flat rate ("Flat rate per purchase").',
                            ...
                            <div className="link-tracking">
                                <div className="segment-title">
                                    ...
                                    <Message
                                        warning
                                        icon='info circle'
                                        header='Here are the main settings for coupon code tracking (you can find them in Affiliate > Details > "Coupon code"):'
                                        list={[
