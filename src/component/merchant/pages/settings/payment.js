	        ...
	        <div className="settings pagecontent">
                    ...
                    <div className="elementScroll">
                        ...
                        <Menu icon='labeled'>
                            ...
                            <Menu.Item as='a' onClick={()=>Public_URL('/settings/payment')} active><Icon name='credit card'/>Payment</Menu.Item>
                        </Menu>
                    </div>
                                        ...
                                        <Form>
                                            ...
                                            <Form.Group inline>
                      												<Field name="is_update">
                      													{({ field, form }) => (
                      														<Form.Field className={(() => {return form.touched[field.name] && form.errors[field.name] ? 'error' : "";})()}>
                      															<Checkbox className="labelagree" toggle id="is_update" label="Update to all active affiliates" checked={values.is_update}
                      																onChange={(e)=>{
