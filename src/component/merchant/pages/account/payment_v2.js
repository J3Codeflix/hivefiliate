...
import ShopifyCheckout from './shopify'
...
export default function AccountPlanV2(props) {
						...
						<div className="account-plan pagecontent">
							...
							<div className="columns">
                                ...
                                <div className="column is-two-fifths">
                                    ...
                                    <div className="pricingheader">Payment Method</div>
                                        <div className="pricingbody">
                                            <div className="columns is-mobile is-vcentered">
                                                ...
                                                <div className="column is-one-quarter"><img src={ShopifyLogo} /></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {ispaypal && <Message positive visible><Icon name='lock' /> You will be redirected to shopify secured website.</Message>}
