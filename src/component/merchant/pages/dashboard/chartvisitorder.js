...
export default function VisitandOrder(props) {
				...
				<div className="dashboard-chart">
				  ...
				  <div className="dashboard-header">
					...
					<div className="dashboard-visitor">
						{selection==4&&<LineChart data={visitorder} discrete={true}  download="Visit and Order"/>}
						{(selection==1 || selection==2 ||selection==3)&&<ColumnChart data={visitorder} discrete={true}  download="Visit and Order"/>}
