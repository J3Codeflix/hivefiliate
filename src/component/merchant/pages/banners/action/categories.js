										...
										<Table celled selectable compact>
											...
											{list.map(function(data, key){
												return <Table.Row key={key} className={data.statcolor}>
													...
													<Table.Cell collapsing>{props.delete==true&&<Button size='tiny' className="red" icon onClick={()=>deleteCategories(data.id)}><Icon name='trash alternate outline' /> Remove</Button>}</Table.Cell>
												</Table.Row>
												})}
											</Table.Body>
										</Table>
