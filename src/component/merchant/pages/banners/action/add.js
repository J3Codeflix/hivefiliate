...
import {getvalidationsadd} from './validate'
   ...
   function handleSubmitForm(values, { props = this.props, setSubmitting, resetForm, setErrors }){
        ...
        seterrorfile(false);
		    if(statefile==''||statefile==null){
				...
				formData.append('type','merchant_addbanner');
        ...
        formData.append('file',statefile);
            ...
            if(obj=='image_required'){
                ...
                return false;
						...
						if(obj==1){
							resetForm();
							if(buttonclick==1){reloadList();showAlert(true,'Your banner was uploaded successfully');closeModal(false);}
							if(buttonclick==2){reloadList();setsuccess(true);}
							setspinner(false);
							return false;
						}
		     ...
		     <Formik
	            ...
	            const { values, isSubmitting, errors, handleChange, handleBlur, handleSubmit, isValid, touched, setFieldValue } = formProps
		          return(
					      ...
					      <Modal.Header>Add Banner<span className="floatright" onClick={()=>closeModal(false)}><i className="ti-close"></i></span></Modal.Header>
						    <Modal.Content className="modalcontent">

								{successmsg&&<AlertSuccess CloseTheAlert={CloseAlert} sizeWidth='full' TextAlert='Banner successfully added'/>}
								{errormsg&&<AlertError CloseTheAlert={CloseAlert} sizeWidth='full' TextAlert='Banner not successfully added'/>}
                        ...
                        <div className="dropzone-container">
                            <div className="dropzone-wrapper">
                                ...
                                <div className="dropText">Drop or click image file here to upload</div>
                                </div>}
                                </DropzoneComponent>
                            </div>
														{errorfile&&<Message style={{'margin-top':'10px'}} negative visible>Banner image is required</Message>}
                            <div className="ishow">
                                <Form.Group inline>
                                    <Field name="is_show">
                                        {({ field, form }) => (
                        ...
                        <div className="columns is-mobile">
                            <div className="column is-two-fifths">
															<label className="inlinelabel">Banner Category</label>
															<h3 className="text-blur">If you havn't seen category on the dropdown, please create categories</h3>
													  </div>
                                ...
                                <Field name="bann_category">
                                    {({ field, form }) => (
                                        <Form.Field className={(() => {return form.touched[field.name] && form.errors[field.name] ? 'error' : "";})()}>
                                            ...
                                            { form.touched[field.name] && form.errors[field.name] && <Label className="ui above prompt label errorlabel">{form.errors[field.name]}</Label> }
                                        </Form.Field>
                                    )}
                                </Field>
                                </Form.Group>
                        ...
                        <div className="columns is-mobile">
                            <div className="column is-two-fifths">
                                ...
                                <h3 className="text-blur">If you leave the width fields empty, then the actual banner's width will be taken</h3>
                            </div>
                            <div className="column">
                                <Form.Group widths='equal'>
                        ...
                        <div className="columns is-mobile">
                            <div className="column is-two-fifths">
                                ...
                                <h3 className="text-blur">If you leave the height fields empty, then the actual banner's height will be taken</h3>
                            </div>
                            <div className="column">
                                <Form.Group widths='equal'>
