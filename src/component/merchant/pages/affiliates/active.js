...
export default function ActiveAffiliates(props) {
	        ...
	        <div className="affiliates-wrapper pagecontent">
                <div className="table-action">
                        ...
                        <div className="columns is-mobile is-vcentered">
                            ...
                            <div className="column">
                                <div className="position-right">
                                    {view_edit==true&&<Button className='black' icon onClick={()=>AddNew()}><Icon name='plus' /> Add Affiliate</Button>}
																		<Button className='black' icon onClick={()=>windowReload()}><Icon name='refresh'/> Refresh</Button>
                                    {/*<Button className='black' icon onClick={()=>setpaysent(true)}><Icon name='bullseye' /> Sent Payment</Button>*/}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="table-navigation">
                        <Menu icon='labeled'>
                            <Menu.Item active as='a' href={process.env.PUBLIC_URL+'/mrcaffiliates/active'}><Icon name='thumbs up outline'/>Active Affiliates</Menu.Item>
                            <Menu.Item as='a' href={process.env.PUBLIC_URL+'/mrcaffiliates/pending'}><Icon name='question circle outline'/>Pending Applications</Menu.Item>
                ...
                <div className="table-wrapper">
                    ...
                    <div className="table-button">
								    	<div className="columns is-mobile is-vcentered">
							              ...
							              <div className="column">
	                              <div className="position-right">
	                                <Button className='green' icon as="a" href={process.env.PUBLIC_URL+'/mrcaffiliates/affpayment'}><Icon name='dollar'/> Affiliate Payment</Button>
																	<Button className='green' icon as="a" href={process.env.PUBLIC_URL+'/mrcaffiliates/payhistory'}><Icon name='file outline'/> Payment History</Button>
	                              </div>
							              </div>
							            </div>
								    </div>
                            ...
                            <Table.Body>
                                {list.length==0&&<Table.Row negative><Table.Cell  colSpan='9' textAlign="center">No record found</Table.Cell></Table.Row>}
			                                ...
			                                <Table.Cell negative>{data.unpaid_earnings}</Table.Cell>
																			<Table.Cell>
																				{/*<Button as="a" href={process.env.PUBLIC_URL+'/mrcaffiliates/payment/?affiliate='+data.id} className='green' size='tiny' icon><Icon name='dollar' /> Payment</Button>*/}
																				<Button className='teal' size='tiny' icon onClick={()=>infoaffiliate(data.id)}><Icon name='cog' /> Details</Button>
																			</Table.Cell>
	  					        						</Table.Row>
                                })}
	  					    					</Table.Body>
