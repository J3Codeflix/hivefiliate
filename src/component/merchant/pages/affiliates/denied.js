...
export default function DeniedAffiliates(props) {
                ...
                <div className="table-action">
                    <div className="table-buttons">
                        <div className="columns is-mobile is-vcentered">
                            <div className="column"><h2 className="titlewrapper">Denied Affiliates</h2></div>
                    ...
                    <div className="table-navigation">
                        <Menu icon='labeled'>
												...
												<Menu.Item active as='a' href={process.env.PUBLIC_URL+'/mrcaffiliates/denied'}><Icon name='thumbs down outline'/>Denied Applications</Menu.Item>
