...
export default function DeletedAffiliates(props) {
    ...
    function CloseModal(data){
		...
		function deleteAllAffiliates(status){
			 setspinner(true);
			 let formData = new FormData();
			 ...
			 .then(function (response) {
				 let obj = response.data;
				 if(obj==1){
					 setalertmessage('Affiliate successfully deleted completely including the associated information.');
					 setsuccess(true);
					 TableList(pagenumber,search);
				 }
				 setspinner(false);
                ...
                <div className="table-action">
                    <div className="table-buttons">
                        <div className="columns is-mobile is-vcentered">
                            <div className="column"><h2 className="titlewrapper">Deleted Affiliates</h2></div>
                    ...
                    <div className="table-navigation">
                        <Menu icon='labeled'>
												...
												<Menu.Item active as='a' href={process.env.PUBLIC_URL+'/mrcaffiliates/deleted'}><Icon name='trash alternate outline'/>Deleted Affiliates</Menu.Item>
                        </Menu>
                    </div>
                </div>
								...
								<Message
									warning
							    icon='info circle'
							    header='Deleted Affiliates'
							    list={[
										'If you delete affiliates mistakenly, this page will you enable to recover it back.',
										'However, if you delete below permanently. It will remove affiliates forever including their associated information.'
									]}
							  />
                ...
                <div className="table-wrapper">
                    ...
                    <div className="table-button">
	                        ...
	                        <div className="position-right">
	                          {list.length>0&&<Button className='red' icon onClick={()=>deleteAllAffiliates('all')}><Icon name='trash' /> Delete All Completely</Button>}
