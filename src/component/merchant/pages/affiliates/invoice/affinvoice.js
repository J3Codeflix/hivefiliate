...
import {id,affiliateid} from '../../../../include/queryurl'

import {UserContext} from '../../../layout/userContext'

import logo from '../../../../../assets/image/logoblack.jpg'
export default function AffPaymentInvoice(props) {
  ...
  function List(){
    if(affiliateid()==null||affiliateid()==''||id()==null||id()==''){returnUrl('/mrcaffiliates/active');}
		setspinner(true);
		let formData = new FormData();
		formData.append('type','monthlyaff_invoice');
