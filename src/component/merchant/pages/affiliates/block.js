...
export default function BlockAffiliates(props) {
                ...
                <div className="table-action">
                    <div className="table-buttons">
                        <div className="columns is-mobile is-vcentered">
                            <div className="column"><h2 className="titlewrapper">Block Affiliates</h2></div>
                    ...
                    <div className="table-navigation">
                        <Menu icon='labeled'>
												...
												<Menu.Item active as='a' href={process.env.PUBLIC_URL+'/mrcaffiliates/block'}><Icon name='dont'/>Block Affiliates</Menu.Item>
