  ...
  const [isoff, setisoff] = useState('off');
	const [state, setstate] = useState({
        id:props.arrayCallback.id,
				is_show:props.arrayCallback.is_show,
	            ...
	            const { values, isSubmitting, errors, handleChange, handleBlur, handleSubmit, isValid, touched, setFieldValue } = formProps
		          return(
						<Modal open={true} size='small'>
					        <Modal.Header>Update Banner<span className="floatright" onClick={()=>closeModal(false)}><i className="ti-close"></i></span></Modal.Header>
