...
export default function OrdersPending(props) {
	        ...
	        <div className="orders pagecontent">
					...
					<div className="table-buttons">
                        <div className="columns is-mobile is-vcentered">
                            <div className="column"><h2 className="titlewrapper">Pending Orders</h2></div>
					...
					<div className="table-navigation">
                        <Menu icon='labeled'>
                            <Menu.Item as='a' onClick={()=>Public_URL('/affiliates/orders/approved')}><Icon name='calendar check outline'/>Approved Orders</Menu.Item>
                            <Menu.Item as='a' onClick={()=>Public_URL('/affiliates/orders/pending')} active><Icon name='calendar times outline'/>Pending Orders</Menu.Item>
